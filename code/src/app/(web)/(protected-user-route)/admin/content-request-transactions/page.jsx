...
const baseColumns = [
  ...
  },
  {
    ...
    minWidth: 160,
    type: 'string',
    field: 'ContentRequest.ContentCreator.displayName',
    headerName: 'Creator Name',
    valueGetter: params => params.row.ContentRequest.ContentCreator.displayName
  },
  {
    flex: 1,
    minWidth: 160,
...
export default function AdminContentRequestTransactionsPage() {
  ...
  async function fetchData() {
    ...
    await MyAxios.get('/admin/transactions/content-request', {
  ...
  return (
    <AdminPageLayout appbarTitle='Content Request Transactions'>
      <Breadcrumb
        data={[
          {
            title: 'Content Request Transactions',
            url: '/admin/content-request-transactions'
          }
        ]}
        action={
          <Fragment>
