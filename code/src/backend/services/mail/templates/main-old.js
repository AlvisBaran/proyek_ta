			...
			<div class="bee-row-content reverse">
				<div class="bee-col bee-col-1 bee-col-w6">
					...
					<div class="bee-block bee-block-3 bee-heading">
						<h1><span class="tinyMce-placeholder">Your content request for {{creatorName}} is ready!<br /></span> </h1>
					</div>
					<div class="bee-block bee-block-4 bee-paragraph">
						<p>You can view the content preview from now and do some payment to get the full content.</p>
					</div>
					<div class="bee-block bee-block-5 bee-button"><a class="bee-button-content" href="{{contentRequestUrl}}" style="font-size: 16px; background-color: #01caa6; border-bottom: 0px solid transparent; border-left: 0px solid transparent; border-radius: 6px; border-right: 0px solid transparent; border-top: 0px solid transparent; color: #ffffff; direction: ltr; font-family: inherit; font-weight: 400; letter-spacing: 0px; max-width: 100%; padding-bottom: 5px; padding-left: 20px; padding-right: 20px; padding-top: 5px; width: 80%; display: inline-block;" target="_blank"><span style="word-break: break-word; font-size: 16px; line-height: 200%; letter-spacing: normal;">Click Here</span></a></div>
				</div>
...
export function getHTML({ creatorName, contentRequestUrl }) {
  const template = compile(htmlTemplate)
  return template({ creatorName, contentRequestUrl })
}
