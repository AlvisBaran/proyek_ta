...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('users_messages', [
      {
        user1Ref: 2,
        user2Ref: 3,
    ...
    await queryInterface.bulkInsert('users_messages_chats', [
      {
        messagesRef: 1,
        authorRef: 2,
      ...
      },
      {
        messagesRef: 1,
        authorRef: 2,
        content: "Nah I'm just want to get in touch with you. Please update me if your page is done! I'll be waiting :))",
